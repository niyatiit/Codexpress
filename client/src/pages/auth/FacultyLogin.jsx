...
const FacultyLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          const res = await axios.post(`${url}/auth/faculty-login`, { email, password }, { withCredentials: true });
      
          if (res.data.success) {
            console.log("Login successful. Saving faculty data to localStorage.");
            localStorage.setItem("user", JSON.stringify(res.data.user)); // Use "faculty" key for faculty data
            ...
            console.log("Redirecting to /faculty");
